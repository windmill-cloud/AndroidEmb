...
public class OhmCalcCameraView extends JavaCameraView {

    public OhmCalcCameraView(Context context, int cameraId) {
        super(context, cameraId);
    }

    public OhmCalcCameraView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
